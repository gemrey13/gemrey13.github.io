  ...
  return (
    <div className="font-droid text-secondary my-6 flex flex-col-reverse items-center justify-center md:my-16 md:flex-row md:space-x-24">
      <motion.img
        ...
        viewport={{ once: true }}
      />
      <article className="flex flex-col space-y-5 overflow-hidden md:w-[40%] md:text-lg/8">
        <motion.p
          whileInView={{ opacity: 1, x: 0 }}
          initial={{ opacity: 0, x: 100 }}
        ...
        >
          ...
          and backend development, where I found my passion for building
        ...
        >
          ...
          Information Technology from Dalubhasaan ng Lungsod ng Lucena, where I
